...
#include <QUrl>
#include <gst/gst.h>
#include "extension/player.h"
//#include "extension/qgstplayer.h"
#include "extension/imagesample.h"
...
int main(int argc, char *argv[])
{
    ...
    //PeterKieu: add register for new QML object
    //qmlRegisterType<Player>("extension", 1, 0, "Player");
